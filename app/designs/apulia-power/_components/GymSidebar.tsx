...
const MODULE_NAV = [
  { key: 'dashboard',   label: 'Dashboard',    path: '/designs/apulia-power/dashboard' },
  { key: 'contacts',       label: 'Contatti',       path: '/designs/apulia-power/contacts' },
  { key: 'conversations',  label: 'Conversazioni', path: '/designs/apulia-power/conversations' },
  { key: 'pipeline',       label: 'Pipeline',       path: '/designs/apulia-power/pipeline' },
  { key: 'calendar',    label: 'Calendario',   path: '/designs/apulia-power/calendar' },
  { key: 'automations', label: 'Automazioni',  path: '/designs/apulia-power/automations' },
  { key: 'settings',    label: 'Impostazioni', path: '/designs/apulia-power/settings' },
] as const

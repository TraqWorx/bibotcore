  ...
  return (
    <div className="relative">
      <select
        ...
        className="h-11 min-w-[220px] appearance-none rounded-[18px] border border-[var(--shell-line)] bg-[var(--shell-surface)] py-2 pl-4 pr-10 text-sm font-semibold text-[var(--foreground)] shadow-sm outline-none transition hover:border-brand/25 focus:border-brand/40 focus:ring-2 focus:ring-brand/15"
        style={{
